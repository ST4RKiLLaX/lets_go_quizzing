...
export const PLAYER_QUESTION_HINTS: Record<string, string> = {
  ...
  click_to_match: 'Click an option, then click an item to match it.',
  drag_and_drop: 'Drag each option into the correct slot, then press Submit.',
...
export const HOST_QUESTION_HINTS: Record<string, string> = {
  ...
  click_to_match: 'Players click an option, then click an item to match it.',
  drag_and_drop: 'Players drag each option into the correct slot, then press Submit.',
