...
import { transition, type GameState, type PendingPlayer } from './game/state-machine.js';
...
import { serializeHostState, serializePlayerState } from './socket/serializers.js';
import { broadcastStateToRoom } from './socket/broadcast.js';
import { saveHistory } from './socket/history.js';
